...
class HomeActivity : FontScaledAppCompatActivity() {
    ...
    private val callLogObserver by lazy { HomeCallLogObserverController(this, handler, ::onCallLogChanged) }
    ...
    private val pullRefreshController by lazy { HomePullRefreshController(binding, handler) }
