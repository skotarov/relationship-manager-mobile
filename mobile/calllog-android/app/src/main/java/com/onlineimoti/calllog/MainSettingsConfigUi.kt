...
object MainSettingsConfigUi {
    fun hydrate(binding: ActivityMainBinding, config: AppConfig) {
        ...
        binding.useOverlayPopupsCheckBox.isChecked = config.useOverlayPopups
        binding.overlayPopupOptionsGroup.visibility = if (config.useOverlayPopups) View.VISIBLE else View.GONE
    ...
    fun read(binding: ActivityMainBinding): AppConfig {
        return AppConfig(
            ...
            useOverlayPopups = binding.useOverlayPopupsCheckBox.isChecked,
