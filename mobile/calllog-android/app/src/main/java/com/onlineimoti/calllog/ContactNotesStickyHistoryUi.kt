...
internal class ContactNotesStickyHistoryUi(
    ...
    private val modeBarUi by lazy { ContactHistoryModeBarUi(activity, ::dp) }
    ...
    fun show(
        ...
        val screen = LinearLayout(activity).apply {
            ...
            addView(modeBarUi.create(mode, onModeSelected), LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT,
                dp(ContactHistoryModeBarUi.BAR_HEIGHT_DP),
            ))
        }
